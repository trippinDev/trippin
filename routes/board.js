...
router.post('/upload', function(req, res, next) {
    ...
    async.waterfall([function(callback){
        fs.stat('/trippin/files/images', function(err, stats){

            if(err){
                fs.mkdir('/trippin/files/images', function(err) {
                    callback(err)
                });
            } else callback();
        });
        ...
        walker('/trippin/files/images')
            .on('dir', function(dir, stat) {
                if(dir == '/trippin/files/images/' + day) {
                    _dir = dir;
                }
            })
